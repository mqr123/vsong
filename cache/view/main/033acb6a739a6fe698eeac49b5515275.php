...
<!--/*
*/-->
<body loading="500" mod="common" page="error" app="main" content="drum">
...
<div class="fxd list-box right r">
	...
	<div id="play-mode" class="list-box-cont">
    	<div style="margin-bottom:30px;"><a class="btn pjax flt-r" href="/main/home/index">返回首页</a><i class="icon icon-hello"></i></div>
        <div type="tips">
