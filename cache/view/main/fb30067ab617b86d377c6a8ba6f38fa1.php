...
<div class="fxd fy r frame-cont">
	<div class="list-box fx">
        ...
        <form id="form-login" onKeyUp="if(event.keyCode == 13){ for(var i=0;i<this.length;i+=1){
				...
				};$('a.vBox-confirm',this).click()}" action="/main/common/login/ff0d85614a61306eb4d52653a0f507a3">
        	<div class="items clr">
            	<h3>用户登录</h3>
            </div>
        	<div class="items">
