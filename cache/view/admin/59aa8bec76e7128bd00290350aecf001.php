...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 5px;">
  ...
  <label style="font-size: 15px; color: red;">发布详情信息</label>&nbsp;
	...
	<!---->
	<!---->
	<form id="conts-form" class="layui-form" style="width:80%;" action="/admin/news/update/2-post" method="post" enctype="multipart/form-data">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
			<input type="text" class="layui-input" name="title" value="斯蒂芬">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">简介</label>
			<div class="layui-input-block">
			<input type="text" class="layui-input" name="summery" value="烦死哒">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">内容</label>
			<div class="layui-input-block">
				<textarea class="layui-textarea" name="content" form="conts-form" >啊地方撒旦</textarea>
