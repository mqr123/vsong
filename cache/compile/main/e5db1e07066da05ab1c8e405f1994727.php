...
<div class="fxd fy r frame-cont">
	<div class="list-box fx">
        ...
        <form id="form-login" onKeyUp="if(event.keyCode == 13){ for(var i=0;i<this.length;i+=1){
				...
				};$('a.vBox-confirm',this).click()}" action="<?php echo $this->url(('common/login/'.$_G['ecode']));?>">
        	<div class="items clr">
            	<h3>用户登录</h3>
            </div>
        	<div class="items">
        	...
        	<div class="items clr" align="center">
            	<label>
                	...
                	<div>
                      ...
                      <a class="btn pjax" href="<?php echo $this->url(('common/register'));?>"><i class="icon icon-btn"></i> 没有帐号，点此注册</a>
                    </div>
                </label>
            </div>
            <div class="items clr" style="height:60px;">
				<?php if (!empty($_G['backUrl'])){ ?><input type="hidden" name="url" value="<?php echo $_G['backUrl'];?>" /><?php } ?>
