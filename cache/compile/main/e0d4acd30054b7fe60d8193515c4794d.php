<?php $spage =& $this->getVariable('spage'); $_G =& $this->getVariable('_G'); $page =& $this->getVariable('page'); $db =& $this->getVariable('db'); $music =& $this->getVariable('music'); $url =& $this->getVariable('url'); $prev =& $this->getVariable('prev'); $next =& $this->getVariable('next'); $pdot =& $this->getVariable('pdot'); $ndot =& $this->getVariable('ndot'); $range =& $this->getVariable('range'); $mmWhere =& $this->getVariable('mmWhere'); $key =& $this->getVariable('key'); $sdb =& $this->getVariable('sdb'); $myScene =& $this->getVariable('myScene'); $scene =& $this->getVariable('scene');  ?>
